# RFG — Copy Completa da Landing Page

> Recebido em 2026-05-05. Estrutura definitiva da landing — todas as 13 seções com copy aprovada e sugestões de design.
> **Nota:** No envio original, as Seções 5, 6 e 7 estavam duplicadas (copy idêntica). Mantida apenas uma versão de cada.

---

## Seção 1: A Chamada Principal (Hero)

### Headline
> Você construiu muito. Sua família está protegida se algo acontecer?
...
### Sugestões de design
- **Hero Image:** Foto real dos sócios Ricardo e Anderson — sentados à mesa com um cliente, em conversa próxima. Transmite acesso direto, confiança e humanidade. Evite imagens de banco de dados. O rosto dos fundadores é o maior ativo de credibilidade aqui.
- **Logos de autoridade:** Selo SUSEP "Registro ativo desde 1995", logo da Mapfre (experiência de Anderson), e qualquer certificação ou associação de classe. Posicionar abaixo do botão ou ao lado da headline. Ancora credibilidade antes do scroll.
...
**Pais e provedores de família**
Você sustenta tudo sozinho e sabe que, se sair de cena, a família fica sem plano. Está na hora de mudar isso.

**Profissionais liberais e autônomos**
Médicos, engenheiros, advogados, dentistas — você exerce sua profissão exposto a riscos que um único processo pode transformar em prejuízo milionário.

**Quem quer realizar sonhos sem pagar juros de banco**
Você quer o imóvel ou o carro que planejou, mas não quer financiar pelo dobro do preço. Existe um caminho melhor.

### Sugestões de design
- **Ícones por persona:** Família (pai/mãe/filhos), estetoscópio ou capacete de engenheiro, chave de imóvel/carro. Linha fina, transmite seriedade.
- **Variação de copy:** Considerar prefixar cada bloco com "Isso é para você se..." — aumenta identificação imediata.
...
### Sugestões de design
- **Depoimentos com dados específicos:** pedir aos clientes versão com dado mensurável ("economizei R$ X em juros", "fui contemplado em X meses", "sinistro resolvido em X dias")
- **Logos de seguradoras parceiras:** priorizar Mapfre, Porto Seguro, Bradesco Seguros e demais reconhecidas
- **Mini estudo de caso "antes / o que foi feito / resultado"** para reforçar prova concreta
- **Selo SUSEP visual** com "Registro ativo desde 1995"
...
Em 1995, Ricardo Farias estava no mercado de seguros e via a mesma cena se repetir toda semana.

Famílias sendo forçadas a escolher.

Proteger o que têm... ou realizar o que sonham. Como se as duas coisas fossem impossíveis ao mesmo tempo.

Anderson Guimarães vivia o mesmo problema — só que do outro lado do balcão. Como gerente territorial na Mapfre, ele via de perto como o sistema funcionava: corretores que apareciam para fechar a venda e sumiam. Gerentes de banco que empurravam previdência com taxas absurdas sem explicar nada. Clientes que só descobriam que tinham feito errado anos depois — quando já era tarde para corrigir.

Os dois perceberam que o problema não era falta de produto. Era falta de alguém que realmente sentasse com a pessoa, entendesse a vida dela, e montasse um plano de verdade.

Ninguém fazia isso. Todo mundo queria só fechar.

---

Em 2013, Ricardo e Anderson decidiram fazer diferente.

Fundaram a RFG não para ser mais uma corretora. Mas para ser o consultor que ninguém antes tinha sido — alguém que olha para o quadro completo, fala com clareza, e fica do lado mesmo depois que o contrato é assinado.
...
Isso se constrói com 35 anos de experiência combinada, registro SUSEP ativo desde 1995, e a decisão de tratar cada cliente como família — não como mais um número na carteira.

### Sugestões de design
- Foto real dos sócios juntos — em contexto de trabalho/atendimento. Usar `socios-02-estudio.png` ou similar.
- Layout em duas colunas (texto + foto) ou foto centrada acima do texto.
...
É um processo em três etapas — feito para a sua realidade, não para uma planilha padrão.

### PASSO 1: O DIAGNÓSTICO DE ÂNGULO MORTO PATRIMONIAL 🔍
Você nos conta o que tem — família, patrimônio, renda, planos.
Nós mostramos o que sobra disso tudo se um imprevisto chegar amanhã.
É a primeira vez que alguém ilumina o ponto que ninguém nunca te mostrou.
...
### PASSO 2: O PLANO PERSONALIZADO 🛡️
Com o diagnóstico em mãos, montamos o seu plano completo.
Proteção da família. Cobertura do patrimônio. Realização dos seus sonhos.
Tudo junto — sem precisar escolher entre um e outro.
...
Aqui é onde a maioria dos corretores some.
Nós ficamos.
Ricardo e Anderson acompanham cada cliente pelo nome — na renovação, no sinistro, na mudança de vida.
Você fala com quem sabe, não com um atendente.
...
## Seção 9: O Caminho — Diagnóstico Gratuito + Plano Personalizado
...
### Bridge
A maioria dos corretores chega com o produto pronto e só ajusta o nome no contrato. A gente faz o contrário.

O primeiro passo com a RFG é o **Diagnóstico de Ângulo Morto Patrimonial** — uma análise personalizada da sua situação real. Sem custo. Sem compromisso. Sem proposta empurrada no final.

A partir do diagnóstico, montamos o seu plano. E o seu plano vai se encaixar em um destes três perfis — dependendo do momento de vida, do tamanho do patrimônio e das suas prioridades.

---

### 🛡️ Caminho 1: Proteção Essencial
...
**Para quem é:** quem ainda não tem proteção montada e quer começar pelo essencial — sem complicar, sem pagar pelo que não precisa.

**Botão:** `Quero proteger minha família — falar no WhatsApp`

---

### 🌟 Caminho 2: Proteção Completa
**(o caminho mais procurado)**
...
- 🎁 Guia "Desvendando a Previdência Inteligente"
- 🎁 Checklist "Meu Patrimônio Blindado — 7 Passos para a Proteção Total"

**Para quem é:** quem já construiu patrimônio, sustenta família e quer um plano integrado — não três produtos avulsos comprados em três lugares diferentes.

**Botão:** `Quero o plano completo — falar no WhatsApp`

---

### 👑 Caminho 3: Legado Familiar
...
**Para quem é:** quem já tem o presente em ordem e quer estruturar o futuro — para os filhos, para a aposentadoria, para o que fica depois da gente.

**Botão:** `Quero construir um legado — falar no WhatsApp`
...
### CTA Único de Reforço

**Não sabe ainda em qual caminho você se encaixa?**
...
**Sem custo. Sem compromisso. Sem proposta empurrada no final.**

**Botão principal:** `Fazer meu diagnóstico gratuito — falar no WhatsApp`

### Sugestões de design
- **Destaque visual no Caminho 2** ("o caminho mais procurado"): borda destacada, selo discreto. **Não** usar termos como "MAIS VENDIDO" — quebra o tom consultivo.
- **Sem campo de preço** em nenhum dos cards. Se houver pressão de "ver número", a faixa "Como o Investimento É Definido" cobre a expectativa.
- **CTA único final** em destaque — botão de maior conversão da página depois do Hero.
- **Microcopy abaixo de cada botão de caminho:** "Diagnóstico gratuito antes de qualquer decisão." Reforça que o clique não compromete nada.
- **Selo SUSEP visível** dentro da seção (canto inferior) — ancoragem de credibilidade no momento de decisão.
- **Vagas limitadas (escassez honesta):** "Ricardo e Anderson atendem pessoalmente. As vagas de diagnóstico são limitadas por mês." Posicionar logo acima do CTA único final.
...
**Você só avança se fizer sentido para você.**

Trabalhamos com mais de 1.200 famílias em 13 anos.
Temos registro SUSEP ativo desde 1995.
...
### Sugestões de design
- **Selo visual:** escudo ou aperto de mão. Tom de confiança construída, não promessa de marketing.
- **Compliance SUSEP:** o termo "garantia" foi removido do título e do corpo (palavra-bandeira vermelha em seguros/consórcio). Foco no compromisso de processo e transparência.
- **Posicionamento:** imediatamente antes ou depois do CTA principal — último empurrão antes do clique no WhatsApp.
...
Você acorda. Toma seu café. E não sente aquele peso.
...
E você chega em casa com menos peso nas costas.

---

### Bloco Negativo (consequência da inação)
**Agora o outro lado.**

Se você não agir, nada muda.
...
**Não deixa o acaso decidir o que acontece com isso.**
...
### 💰 "Seguro é caro demais para o que eu ganho agora."
...
### ⏳ "Ainda sou novo. Posso deixar para depois."
...
### 🤝 "Já fui enganado por corretor antes. Por que vocês seriam diferentes?"
...
### 📋 "Não entendo nada disso. Tenho medo de fazer errado de novo."
...
### 📅 "Agora não é o momento. Tenho outras prioridades."
...
### Sugestões de design
- **Ícones por objeção:** 💰 (custo), ⏳ (idade), 🤝 (desconfiança), 📋 (medo de errar), 📅 (não é o momento)
- **Frases-chave em negrito** funcionam como âncoras de leitura para quem escaneia
- **CTA logo após Seção 12:** "Fazer meu diagnóstico agora" / "Enviar minha demanda pelo WhatsApp" — quem chega aqui está quase pronto
- **Foto dos fundadores próxima:** rostos reais aumentam confiança, especialmente para tráfego do Instagram
...
**10. Por que devo confiar na RFG e não em outro corretor?**
...
### Sugestões de design
- **Ordem mantida:** segue jornada mental ("é para mim?" → "posso confiar?")
- **Acordeão (colapsável):** não sobrecarrega visualmente; visitante abre só o que tem dúvida
- **CTA final do FAQ:** "Ainda tem dúvida? Fala direto com a gente." → WhatsApp
- **Faixa de referência de valores** na pergunta de orçamento ("a partir de R$ X/mês") reduz ansiedade

---

## Resumo da Estrutura (13 seções)

| # | Seção | Função | CTA? |
|---|-------|--------|------|
| 1 | Hero / Chamada Principal | Hook + headline + autoridade | ✓ Primary |
| 2 | Problema Primário | Desperta dor (Ponto Cego Patrimonial) | — |
| 3 | A Oportunidade | Apresenta solução (Diagnóstico de Ângulo Morto) | — |
| 4 | Para Quem É | 3 personas/avatares | — |
| 5 | Proposta de Valor | 4 pilares com benefícios | — |
| 6 | Prova | Depoimentos + selos + faixa parceiros | — |
| 7 | História de Origem | Storytelling fundadores 1995/2013 | — |
| 8 | Como Funciona | 3 passos do processo | — |
| 9 | Oferta e Preços | 3 pacotes (Essencial / Completa / Legado) | ✓ 3x |
| 10 | Garantia | Quebra desconfiança final | — |
| 11 | Visão de Futuro | Imersão dois anos (positivo + negativo) | — |
| 12 | Últimas Dúvidas | 5 objeções endereçadas | ✓ Após |
| 13 | FAQ | 10 perguntas frequentes | ✓ Final |

## Decisões pendentes pra próxima fase
- [ ] Confirmar valores reais dos 3 pacotes com Ricardo e Anderson
- [ ] Confirmar logos das seguradoras parceiras pra faixa de autoridade
- [ ] Decidir se a landing terá vídeo institucional (60–90s) na Seção 8
- [ ] Definir foto principal do hero (sócios + cliente, ou só sócios?)
- [ ] Coletar depoimentos com dados mensuráveis (R$, prazo, etc) — fortalece prova social
- [ ] Definir paleta neutra (greys/off-whites) complementar ao gradiente RFG
- [ ] Definir tipografia (fonte primária + secundária)
